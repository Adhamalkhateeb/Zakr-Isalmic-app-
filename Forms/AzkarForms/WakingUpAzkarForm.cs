...
namespace Islamic_app.Forms
{
    public partial class WakingUpAzkarForm : Form
    {
        private List<Button> _btnRepeats;
        private List<Panel> _panels;
        private clsAzkar _azkar;
        public WakingUpAzkarForm()
        {
            InitializeComponent();
        ...
        private void WakingUpAzkarForm_Load(object sender, EventArgs e)
        {
        ...
        private void WakingUpAzkarForm_Click(object sender, EventArgs e)
        {

        }

        private void WakingUpAzkarForm_Paint(object sender, PaintEventArgs e)
        {
