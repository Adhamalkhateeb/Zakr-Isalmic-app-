...
{
    public partial class PrayingAzkarForm : Form
    {
        private List<Button> _btnRepeats;
        private List<Panel> _panels;
        private clsAzkar _azkar;
        public PrayingAzkarForm()
        {
            InitializeComponent();
            ...
            {
                txt1,txt32, txt2, txt3, txt4, txt5, txt6, txt7, txt8, txt9, txt10, txt11,txt12
        ...
        private void PrayingAzkarForm_Load(object sender, EventArgs e)
        {
        ...
        private void PrayingAzkarForm_Paint(object sender, PaintEventArgs e)
        {
