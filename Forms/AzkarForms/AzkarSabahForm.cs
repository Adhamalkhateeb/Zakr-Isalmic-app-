...
{
    public partial class frmAzkarSabah : Form
    {
        ...
        public frmAzkarSabah()
        {
            InitializeComponent();
            
            _btnRepeats = new List<Button>
            {
               btnRepeats1, btnRepeats2, btnRepeats3, btnRepeats4, btnRepeats5,
            ...
            TextBox[] textBoxes = new TextBox[]
            {
                ...
                txt22, txt23, txt24, txt25, txt26, txt27, txt28, txt29,txt30,txt31
            };
        ...
        private void frmAzkarSabah_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void frmAzkarSabah_Load(object sender, EventArgs e)
        {
            this.AutoScroll = true;
        }

        private void frmAzkarSabah_SizeChanged(object sender, EventArgs e)
        {
